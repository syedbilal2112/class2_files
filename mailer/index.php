...
'allow_self_signed' => true
    ...
    $mail->setFrom('syedbilalhussain.sbh12@gmail.com', 'Infi data');
    ...
    $body = '<p>A customer wants to contact us</p><p>Name : .'.$name.'</p><p>Email : '.$email.'</p><p><p>Message: '.$comment.'</p><p>Message : '.$message.' </p>';
